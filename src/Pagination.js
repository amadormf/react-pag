    ...
    const classes = classNames({
      ...
      [styles['Pagination-element--selected']]:
        pageOption.actualPage
          ...
          && !!styles['Pagination-element--selected'],
      'Pagination-element--specialButton-next-page': actualPage === lastPage && pageOption.specialButton && pageOption.specialButton == Pagination.NEXT),
      'Pagination-element--specialButton-previous-page': actualPage === 1 && pageOption.specialButton && pageOption.specialButton == Pagination.PREVIOUS),
      'Pagination-element--specialButton-first-page': actualPage === 1 && pageOption.specialButton && pageOption.specialButton == Pagination.FIRST),
      'Pagination-element--specialButton-last-page': actualPage === lastPage && pageOption.specialButton && pageOption.specialButton == Pagination.LAST),
